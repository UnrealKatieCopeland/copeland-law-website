        ...
        <CardContent className="p-10 text-center">
          ...
          <div className="mt-8 p-6 bg-primary/5 rounded-sm">
            <p className="text-sm text-foreground/70">
              <strong>Share your results:</strong> "I scored {score}/{quizQuestions.length} on The Copeland Questions™ Quiz. Test your understanding of disability access law in courtrooms!"
            </p>
          </div>
        </CardContent>
      </Card>
