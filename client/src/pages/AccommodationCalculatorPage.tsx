    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-background">
        <div className="container max-w-5xl">
          ...
          <div className="p-6 bg-primary/5 border-l-4 border-primary rounded-sm">
            <p className="text-base text-foreground/80 leading-relaxed">
              <strong>Note:</strong> This tool provides educational guidance based on federal disability law and The Copeland Questions™ framework. It is not a substitute for legal advice. For case-specific counsel, consult with an attorney experienced in ADA litigation.
            </p>
          </div>
        </div>
      </section>
