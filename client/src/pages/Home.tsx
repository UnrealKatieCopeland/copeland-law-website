      ...
      <section className="py-24 bg-gradient-to-b from-primary/5 to-background">
        <div className="container">
          <div className="text-center mb-16">
            ...
            <h2 className="mb-6">Explore. Learn. Take Action.</h2>
            <p className="text-xl text-foreground/70 max-w-3xl mx-auto">
              Use these interactive tools to understand your rights, identify accommodations, and navigate the legal system
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="border-primary/20 hover:border-primary/40 hover:shadow-lg transition-all group">
              <CardContent className="p-8">
                ...
                <h3 className="text-2xl font-display font-bold mb-4">Take the Quiz</h3>
            ...
            <Card className="border-primary/20 hover:border-primary/40 hover:shadow-lg transition-all group">
              <CardContent className="p-8">
                ...
                <h3 className="text-2xl font-display font-bold mb-4">Get Recommendations</h3>
                <p className="text-base text-foreground/70 leading-relaxed mb-6">
            ...
            <Card className="border-primary/20 hover:border-primary/40 hover:shadow-lg transition-all group">
              <CardContent className="p-8">
                ...
                <h3 className="text-2xl font-display font-bold mb-4">Find Your Path</h3>
                <p className="text-base text-foreground/70 leading-relaxed mb-6">
